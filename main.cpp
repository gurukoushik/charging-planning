...
enum Method {
  /*
  Find the minimum deviation city which is reachable with a fully charged
  battery which satisfies minimum(d(start, city) + d(city, goal) - d(start,
  goal)) and d(start, city) < MAX_RANGE At each city, charge the battery to full
  capacity.
  */
  ...
  Find the minimum deviation city which is reachable with a fully charged
  battery which satisfies minimum(d(start, city) + d(city, goal) - d(start,
  goal)) and d(start, city) < MAX_RANGE At each city, charge the battery just
  enough to reach the next city.
  */
  BRUTE_FORCE_CHARGE_GREEDY,
  /*
  Find the minimum deviation city which is reachable with a fully charged
  battery which satisfies minimum(d(start, city) + d(city, goal) - d(start,
  goal)) and d(start, city) < MAX_RANGE Find the optimal charging strategy which
  minimizes the sum of time spent charging at each city
  */
  BRUTE_FORCE_CHARGE_OPTIMAL,
  /*
  Run a Monte Carlo simulation to randomly find different paths from start to
  goal and evaluate the total time taken to complete the trip. Keep track of the
  path which takes the minimum time. At each city, charge the battery just
  enough to reach the next city.
  */
  ...
  Run a Monte Carlo simulation to randomly find different paths from start to
  goal and evaluate the total time taken to complete the trip. Keep track of the
  path which takes the minimum time. Find the optimal charging strategy which
  minimizes the sum of time spent charging at each city
  */
